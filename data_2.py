...
class CustomDataset(Dataset):
    def __init__(self, fname, tokenizer):
        ...
        PROMPT = '''You are a native Korean speaker and you must correctly match Korean reasoning to five categories: cause, subsequent event, prerequisite, motivation, and emotional reaction.'''
        answer_dict = {
            "": None,
            "inference_1": 0,
            "inference_2": 1,
